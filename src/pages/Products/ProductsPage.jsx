                  ...
                  <tr key={p.id} className={`prod-tr ${i % 2 !== 0 ? "prod-tr-alt" : ""}`}>
                    ...
                    <td className="prod-td prod-td-right">
                      <span className={`prod-stock ${p.stock <= 5 ? "prod-stock-low" : p.stock <= 20 ? "prod-stock-mid" : ""}`}>
                        {p.stock}
                        {p.stock <= 5 && <span className="prod-stock-warn"> ⚠ bajo</span>}
                      </span>
                    </td>
                    ...
                    <td className="prod-td prod-td-center">
                      <div className="prod-actions">
                        <button className="prod-btn-edit" onClick={() => openEdit(p)}>
                          Editar
                        </button>
                        <button className="prod-btn-delete" onClick={() => setDeleteId(p.id)}>
                          Eliminar
                        </button>
                      </div>
                    </td>
